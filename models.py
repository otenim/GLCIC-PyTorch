...
class CompletionNetwork(nn.Module):
    def __init__(self, input_shape):
        ...
        self.conv17 = nn.Conv2d(32, self.__img_c, kernel_size=3, stride=1, padding=1)
...
class LocalDiscriminator(nn.Module):
    def __init__(self, input_shape):
        ...
        self.__img_w = input_shape[2]
        # input_shape: (None, img_c, img_h, img_w)
        self.conv1 = nn.Conv2d(self.__img_c, 64, kernel_size=5, stride=2, padding=2)
        self.bn1 = nn.BatchNorm2d(64)
        ...
        in_features = 512 * (self.__img_h//32) * (self.__img_w//32)
