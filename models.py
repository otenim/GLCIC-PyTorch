...
class ContextDiscriminator(nn.Module):
    ...
    def __init__(self, local_input_shape, global_input_shape, mode='celeba'):
        ...
        self.model_gd = GlobalDiscriminator(global_input_shape, mode=self.mode)
