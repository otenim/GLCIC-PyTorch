...
parser.add_argument('--Tc', type=int, default=36000)
parser.add_argument('--Td', type=int, default=4000)
parser.add_argument('--Ttrain', type=int, default=200000)
parser.add_argument('--snaperiod_phase_1', type=int, default=4000)
parser.add_argument('--snaperiod_phase_2', type=int, default=4000)
parser.add_argument('--snaperiod_phase_3', type=int, default=4000)
...
parser.add_argument('--ptch_min_w', type=int, default=16)
parser.add_argument('--ptch_max_w', type=int, default=48)
parser.add_argument('--ptch_min_h', type=int, default=16)
